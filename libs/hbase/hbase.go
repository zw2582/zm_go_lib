...
func (p *GetColumnDescriptorsResult) ReadField0(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		if err := _val101.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _val101, err)
		}
...
func (p *GetRowResult) ReadField0(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		if err := _elem115.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _elem115, err)
		}
...
func (p *GetRowTsResult) ReadField0(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		if err := _elem122.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _elem122, err)
		}
...
func (p *GetRowsResult) ReadField0(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		if err := _elem130.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _elem130, err)
		}
...
func (p *IncrementRowsArgs) ReadField1(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		if err := _elem163.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _elem163, err)
		}
...
func (p *ScannerGetListResult) ReadField0(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		if err := _elem184.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _elem184, err)
		}
...
func (p *GetRowOrBeforeResult) ReadField0(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		if err := _elem185.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _elem185, err)
		}
